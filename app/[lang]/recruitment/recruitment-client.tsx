...
interface JobRecruitmentClientProps {
  initialJobs: Job[];
  initialError: string | null;
}

export default function JobRecruitmentClient({ initialJobs, initialError }: JobRecruitmentClientProps) {
  ...
  }, [jobs, selectedDept, selectedType, query]);
  ...
  }, [filteredJobs, isMobile, selectedJob]);
